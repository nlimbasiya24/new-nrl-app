...
export function QRCodeForm({ QRCode: InitialQRCode }) {
 ...
 // console.log("QRCODE is there",QRCode);
...
//   }
  ...
  */
  ...
  const QRCodeURL = QRCode
    ? new URL(`/api/${QRCode._id}/image`, location.toString()).toString()
    : null;
  console.log("QrCODE URL ADADADA", QRCodeURL);

  // const QRCodeURL = useAppQuery({ url: `/api/${QRCode._id}/image` });

  // console.log("data is there", QRCodeURL);
